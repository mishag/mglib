#ifndef INCLUDED_MGMT_THREADPOOL_H
#define INCLUDED_MGMT_THREADPOOL_H
...
public:
    ...
    explicit mgmt_ThreadPool(int numThreads);
...
private:
    ...
    mgmt_ThreadPool(const mgmt_ThreadPool & tp);
    mgmt_ThreadPool & operator=(const mgmt_ThreadPool & rhs);
